    ...
    return (
        <div>
            ...
            <div className="">
                ...
                <div className='divider relative top-[-120px] '> <Link to={'/all-movies'}><span className='bg-gradient-to-r text-xl font-bold to-[#5FE1E7] from-[#D3F46D] text-black px-6 py-2 hover:rounded-xl hover:transform hover:duration-200'>See all movies</span></Link> </div>
