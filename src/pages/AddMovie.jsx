            ...
            <section className="max-w-4xl p-6 mx-auto bg-indigo-600 rounded-md shadow-md dark:bg-gray-800 my-10">
                ...
                <form>
                    <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label className="text-white dark:text-gray-200" for="passwordConfirmation">Release Year</label>
                            {/* <input id="date" type="year" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" /> */}
                            <input type="date" id="release-year" name="releaseYear" placeholder="YYYY" required />
                        </div>
                        <div>
